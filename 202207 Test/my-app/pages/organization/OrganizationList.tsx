...
const OrganizationList = () => {
  ...
  const [organization, setOrganization]=useState<Organization>({organizationId:0, date:"", name:"" , introduction:"", phone:"" , email:"" , address:""})//organization to be updated
  ...
  const addOrganization = () => {
    setOrganization({organizationId:0, date:"", name:"" , introduction:"", phone:"" , email:"" , address:""});
    setOpen(true);
  }

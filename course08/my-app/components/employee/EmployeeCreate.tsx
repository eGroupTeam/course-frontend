        ...
        <div className={styles.container}>
            <form onSubmit={handleSubmit(onSubmit)}>
                <Dialog open={props.open} onClose={handleClose}>
                    ...
                    <DialogContent>
                        <TextField id="filled-basic" label="員工姓名" variant="outlined" {...register("name", { required: true })}></TextField><br />
                        {errors.name && <span>必填<br /></span>}
                        <TextField id="filled-basic" label="員工部門" variant="outlined" {...register("department", { required: true })}></TextField><br />
                        {errors.department && <span>必填<br /></span>}
                    </DialogContent>
                    <DialogActions>
